...
class BaseAgent(ABC):
    ...
    @staticmethod
    def _append_unique_path(paths: List[str], seen: set[str], filepath: str) -> None:
    ...
    @classmethod
    def _build_legacy_attachments_prompt(cls, message: Message) -> str:
        """构建 legacy planner/react 使用的附件提示块。"""
