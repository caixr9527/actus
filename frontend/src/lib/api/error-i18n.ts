...
const API_ERROR_MESSAGE_KEY_BY_ERROR_KEY: Record<string, string> = {
  ...
  "error.document_input.unsupported_media_image": "apiErrors.documentInput.unsupportedTaskInput",
  "error.document_input.unsupported_media_audio": "apiErrors.documentInput.unsupportedTaskInput",
  "error.document_input.unsupported_media_video": "apiErrors.documentInput.unsupportedTaskInput",
  "error.document_input.unsupported_binary": "apiErrors.documentInput.unsupportedTaskInput",
