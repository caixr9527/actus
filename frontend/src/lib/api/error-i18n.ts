...
const API_ERROR_MESSAGE_KEY_BY_ERROR_KEY: Record<string, string> = {
  ...
  "error.session.wait_task_not_found": "apiErrors.session.waitTaskNotFound",
  "error.session.resume_token_invalid": "apiErrors.session.resumeTokenInvalid",
  "error.session.wait_task_timeout": "apiErrors.session.waitTaskTimeout",
